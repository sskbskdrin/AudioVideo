...
#ifdef YUVSCALEUP
// Scale YUVLib to ARGB up with bilinear interpolation.
static void ScaleYUVToARGBBilinearUp(int src_width,
  ...
  // TODO(fbarchard): Convert first 2 rows of YUVLib to ARGB.
...
// Scale with YUVLib conversion to ARGB and clipping.
LIBYUV_API
