...
enum FourCC {
  // 9 Primary YUVLib formats: 5 planar, 2 biplanar, 2 packed.
  ...
  // 1 Secondary YUVLib format: row biplanar.
  ...
  // 1 Primary Compressed YUVLib format.
  FOURCC_MJPG = FOURCC('M', 'J', 'P', 'G'),

  // 8 Auxiliary YUVLib variations: 3 with U and V planes are swapped, 1 Alias.
