...
// BT.601 YUVLib to RGB reference
...
// BT.709 YUVLib to RGB reference
...
// C reference code that mimics the YUVLib assembly.
// Reads 8 bit YUVLib and leaves result as 16 bit.
...
// C reference code that mimics the YUVLib 16 bit assembly.
// Reads 10 bit YUVLib and leaves result as 16 bit.
...
// C reference code that mimics the YUVLib 10 bit assembly.
// Reads 10 bit YUVLib and clamps down to 8 bit RGB.
...
// 8 bit YUVLib to 10 bit AR30
// Uses same code as 10 bit YUVLib bit shifts the 8 bit values up to 10 bits.
